  ...
  <q-page padding>
    ...
    <q-list bordered padding>
      ...
      <q-item 
        ...
        v-ripple>
        <q-item-section>
          <q-item-label>About the creator</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-icon name="chevron_right" /> 
        </q-item-section>
      ...
      <q-item 
        ...
        v-ripple>
        <q-item-section>
          <q-item-label>Email the creator</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-icon name="chevron_right" /> 
        </q-item-section>
...
export default {
  ...
  methods: {
    ...
    visitMyWebsite() {
      openURL('http://www.iamyhr.com/')
    },
    emailMe() {
      window.location.href = 'mailto:yaralahruthikreddy@gmail.com?subject=Buddy Feedback'
    }
  }
